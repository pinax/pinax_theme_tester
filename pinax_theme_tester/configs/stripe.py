...
views = [
    ...
    ViewConfig(pattern=r"^invoices/$", template="pinax/stripe/invoice_list.html", name="invoice_list", pattern_kwargs={}, object_list=invoices),
    ...
    ViewConfig(pattern=r"^methods/$", template="pinax/stripe/paymentmethod_list.html", name="method_list", pattern_kwargs={}, object_list=methods),
    ViewConfig(pattern=r"^methods/create/$", template="pinax/stripe/paymentmethod_create.html", name="pinax_stripe_payment_method_create", pattern_kwargs={}),
    ...
    ViewConfig(pattern=r"^subscriptions/$", template="pinax/stripe/subscription_list.html", name="subscription_list", pattern_kwargs={}, object_list=subscriptions),
    ViewConfig(pattern=r"^subscriptions/create/$", template="pinax/stripe/subscription_create.html", name="pinax_stripe_subscription_create", pattern_kwargs={}, form=PlanForm()),
    ViewConfig(pattern=r"^subscriptions/update/(?P<pk>\d+)/$", template="pinax/stripe/subscription_update.html", name="pinax_stripe_subscription_update", pattern_kwargs={"pk": 1}, object=subscription, form=PlanForm()),
